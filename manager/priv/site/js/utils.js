...
nm.utils.formatStr = function(str)
{
	var args = arguments;
...
nm.utils.getTimeStr = function(time)
{
	if(!time)
	{
		var time = new Date();
...
nm.utils.getTimeByMinute = function(minute)
{
	var time = new Date();
...
nm.utils.getTimeByHour = function(hour)
{
	var time = new Date();
...
nm.utils.getTimeByDay = function(day)
{
	var time = new Date();
