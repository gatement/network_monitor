...
integer_to_length_coded_binary(_) ->
  #mysql_error{type = statement, source="util:integer_to_length_coded_binary/1", message = "Parameter is too long."}
.
...
%% @spec atom_list_to_string(Value::list()) -> string()
%%
%% @doc Converts list of atoms to a string that contains string representation of atoms separated by comma.
%%
atom_list_to_string(P) ->
  lists:foldl(
